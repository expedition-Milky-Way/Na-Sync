...
public class Main {
    ...
    private static String path = "E:\\测试\\测试压缩";

    private static String zipPath = "E:\\测试\\元数据";
    ...
    public static String excelPath = "E:\\测试\\元数据";

    public static String excelName = "重要数据";
    ...
    public void zip(Map<String, List<File>> didMap) {
        ...
        while (keySet.hasNext()) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String[] parentStrs = parent.split("/");
                String hashParent = parentCrypto(parentStrs[parentStrs.length - 1]);
...
//            zipParameters.setCompressionMethod(CompressionMethod.STORE);
    ...
    private static File genTheZipFile(String hashParent) {
        ...
        while (zipFile.exists()) {
            if (zipName.contains("(")) {
                zipName = zipName.replace("(" + (index - 1) + ").zip", "(" + index + ").zip");
            } else {
